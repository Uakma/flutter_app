...
class BookRequest {
  ...
  Map get jsonSerialize {
    ...
    return provider?.toLowerCase() == FlightType.KIWI
        ? {
...
class Passenger {
  ...
  Map get jsonSerialize => {
        "birthday": Helper.getDateViaDate(birthday, 'yyyy-MM-dd'), // "2001-08-11T17:00:00.000Z"
        "cardno": this.cardno,
        "category": this.category,
        "expiration": Helper.getDateViaDate(this.expiration, 'yyyy-MM-dd'),
        "name": this.name,
