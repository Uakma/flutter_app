...
class CheckFlightResponse {
  ...
  CheckFlightResponse(
      this.baggage, this.flightsChecked, this.flightsInvalid, this.total);
...
class Conversion {
  ...
  factory Conversion.fromJson(Map<String, dynamic> json) {
    return Conversion(
        json['currency'], double.parse(json['amount'].toString()));
  }
}
...
class BaggageItem {
  ...
  factory BaggageItem.fromJson(Map<String, dynamic> json) {
    var handBag =
        (json['hand_bag'] as List).map((i) => BagItem.fromJson(i)).toList();
    var holdBag =
        (json['hold_bag'] as List).map((i) => BagItem.fromJson(i)).toList();
...
class BagItem {
  ...
  BagItem(String category, Conditions conditions, List<dynamic> indices,
      Price price,
      {String uuid}) {
  ...
  @override
  String toString() {
    return 'BagItem: {$category, $conditions, $indices, $price, $uuid  }';
  }
}
...
class Conditions {
  ...
  Map get jsonSerialize => {"passenger_groups": this.passengerGroups};
  @override
  String toString() {
    return 'Conditions: { $passengerGroups }';
  }
}
...
class Price {
  ...
  @override
  String toString() {
    return 'Price: { $amount, $base, $currency, $merchant, $service, $serviceFlat }';
  }
}
